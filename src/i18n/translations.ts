...
const ml: TranslationKeys = { ...en, home: 'ഹോം', nearby: 'മസ്ജിദുകൾ', qibla: 'ഖിബ്ല', tracker: 'ട്രാക്കർ', settings: 'ക്രമീകരണം', nextPrayer: 'അടുത്ത നമസ്കാരം', language: 'ഭാഷ', selectLanguage: 'ഭാഷ തിരഞ്ഞെടുക്കുക', prayerTimes: 'നമസ്കാര സമയം', offline: 'ഓഫ്‌ലൈൻ', online: 'ഓൺലൈൻ', searchMosques: 'മസ്ജിദ് തിരയുക...', fajr: 'ഫജ്ര്', dhuhr: 'ദുഹ്ര്', asr: 'അസ്ര്', maghrib: 'മഗ്‌രിബ്', isha: 'ഇശാ', witr: 'വിത്ര്', myMohalla: 'എന്റെ മഹല്ല', ramadanMode: 'റമദാൻ മോഡ്', tahajjud: 'തഹജ്ജുദ്', ishraq: 'ഇശ്‌റാഖ്' };
const te: TranslationKeys = { ...en, home: 'హోమ్', nearby: 'మస్జిద్‌లు', qibla: 'ఖిబ్లా', tracker: 'ట్రాకర్', settings: 'సెట్టింగ్‌లు', nextPrayer: 'తదుపరి నమాజ్', language: 'భాష', selectLanguage: 'భాషను ఎంచుకోండి', prayerTimes: 'నమాజ్ సమయాలు', offline: 'ఆఫ్‌లైన్', online: 'ఆన్‌లైన్', searchMosques: 'మస్జిద్ శోధించండి...', fajr: 'ఫజ్ర్', dhuhr: 'జుహర్', asr: 'అస్ర్', maghrib: 'మగ్రిబ్', isha: 'ఇషా', witr: 'విత్ర్', myMohalla: 'నా మొహల్లా', ramadanMode: 'రంజాన్ మోడ్', tahajjud: 'తహజ్జుద్', ishraq: 'ఇష్‌రాక్' };
const kn: TranslationKeys = { ...en, home: 'ಹೋಮ್', nearby: 'ಮಸ್ಜಿದ್‌ಗಳು', qibla: 'ಕಿಬ್ಲಾ', tracker: 'ಟ್ರ್ಯಾಕರ್', settings: 'ಸೆಟ್ಟಿಂಗ್ಸ್', nextPrayer: 'ಮುಂದಿನ ನಮಾಜ್', language: 'ಭಾಷೆ', selectLanguage: 'ಭಾಷೆ ಆಯ್ಕೆ', prayerTimes: 'ನಮಾಜ್ ಸಮಯ', offline: 'ಆಫ್‌ಲೈನ್', online: 'ಆನ್‌ಲೈನ್', searchMosques: 'ಮಸ್ಜಿದ್ ಹುಡುಕಿ...', fajr: 'ಫಜ್ರ್', dhuhr: 'ಜುಹ್ರ್', asr: 'ಅಸ್ರ್', maghrib: 'ಮಗ್ರಿಬ್', isha: 'ಇಶಾ', witr: 'ವಿತ್ರ್', myMohalla: 'ನನ್ನ ಮೊಹಲ್ಲಾ', ramadanMode: 'ರಂಜಾನ್ ಮೋಡ್', tahajjud: 'ತಹಜ್ಜುದ್', ishraq: 'ಇಶ್ರಾಕ್' };
const bn: TranslationKeys = { ...en, home: 'হোম', nearby: 'মসজিদসমূহ', qibla: 'কিবলা', tracker: 'ট্র্যাকার', settings: 'সেটিংস', nextPrayer: 'পরবর্তী নামাজ', language: 'ভাষা', selectLanguage: 'ভাষা নির্বাচন', prayerTimes: 'নামাজের সময়', offline: 'অফলাইন', online: 'অনলাইন', searchMosques: 'মসজিদ খুঁজুন...', fajr: 'ফজর', dhuhr: 'জোহর', asr: 'আসর', maghrib: 'মাগরিব', isha: 'ইশা', witr: 'বিতর', myMohalla: 'আমার মহল্লা', ramadanMode: 'রমজান মোড', tahajjud: 'তাহাজ্জুদ', ishraq: 'ইশরাক' };
const gu: TranslationKeys = { ...en, home: 'હોમ', nearby: 'મસ્જિદો', qibla: 'કિબલા', tracker: 'ટ્રેકર', settings: 'સેટિંગ્સ', nextPrayer: 'આગામી નમાઝ', language: 'ભાષા', selectLanguage: 'ભાષા પસંદ કરો', prayerTimes: 'નમાઝ સમય', offline: 'ઑફલાઇન', online: 'ઑનલાઇન', searchMosques: 'મસ્જિદ શોધો...', fajr: 'ફજર', dhuhr: 'ઝોહર', asr: 'અસર', maghrib: 'મગરિબ', isha: 'ઈશા', witr: 'વિત્ર', myMohalla: 'મારું મોહલ્લો', ramadanMode: 'રમઝાન મોડ', tahajjud: 'તહજ્જુદ', ishraq: 'ઇશરાક' };
const mr: TranslationKeys = { ...en, home: 'मुख्यपृष्ठ', nearby: 'मशिदी', qibla: 'किबला', tracker: 'ट्रॅकर', settings: 'सेटिंग्ज', nextPrayer: 'पुढील नमाज', language: 'भाषा', selectLanguage: 'भाषा निवडा', prayerTimes: 'नमाज वेळा', offline: 'ऑफलाइन', online: 'ऑनलाइन', searchMosques: 'मशीद शोधा...', fajr: 'फज्र', dhuhr: 'झोहर', asr: 'अस्र', maghrib: 'मगरिब', isha: 'इशा', witr: 'वित्र', myMohalla: 'माझे मोहल्ला', ramadanMode: 'रमजान मोड', tahajjud: 'तहज्जुद', ishraq: 'इश्राक' };
