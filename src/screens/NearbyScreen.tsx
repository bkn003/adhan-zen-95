...
export const NearbyScreen = ({
  ...
  if (isLoading) {
    return (
      <div className="p-4 pb-20 space-y-4 bg-gradient-to-br from-green-50 via-emerald-50 to-white min-h-screen">
    ...
    <div className="p-4 pb-20 space-y-4 bg-gradient-to-br from-green-50 via-emerald-50 to-white min-h-screen">
      ...
      <div className="bg-white rounded-xl p-4 border border-green-100 space-y-3">
        ...
        <div className="flex gap-2 flex-wrap">
          <Button
            variant={filterSaharFood ? "default" : "outline"}
            size="sm"
          ...
          <Button
            variant={filterWomenHall ? "default" : "outline"}
            size="sm"
      ...
      <div className="space-y-3">
        {isLoading || isSearching ? (
          ...
          sortedLocations.map(location => (
            <div key={location.id} className="bg-white rounded-xl p-4 border border-green-100 space-y-3">
              ...
              <div className="flex gap-2">
                <button 
                  ...
                  className="flex-1 flex items-center justify-center gap-2 bg-green-600 text-white rounded-lg font-medium hover:bg-green-700 transition-colors text-sm py-2.5 px-4"
                >
                ...
                <button 
                  ...
                  className="flex-1 flex items-center justify-center gap-2 bg-blue-600 text-white rounded-lg font-medium hover:bg-blue-700 transition-colors text-sm py-2.5 px-4"
                >
